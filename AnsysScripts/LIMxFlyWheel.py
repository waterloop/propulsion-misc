...
for objects in oEditor.GetObjectsInGroup("Solids"):
	# python string concatenation
	selections2 = selections2+objects+","

for sheets in oEditor.GetObjectsInGroup("Sheets"):
    selections2 = selections2+sheets+","
...
oEditor.Move(
	...
	[
		...
		"TranslateVectorY:="	, "$total_width/2+$edge_to_edge",
		"TranslateVectorZ:="	, "0mm"
	])
...
for objects in oEditor.GetObjectsInGroup("Solids"):
	# python string concatenation
	selections3 = selections3+objects+","

for sheets in oEditor.GetObjectsInGroup("Sheets"):
    selections3= selections3+sheets+","
